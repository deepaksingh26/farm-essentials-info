				...
				<div className="container-custom relative z-10 py-20">
					<div className="max-w-3xl animate-fade-in-up">
						...
						<p className="text-primary-foreground/80 text-lg mb-8 max-w-2xl">
							We are committed to providing authentic, high-quality agricultural
							inputs to help farmers achieve better yields and sustainable farming
							success.
						</p>
			...
			<section className="section-padding bg-primary">
				<div className="container-custom text-center">
					...
					<p className="text-primary-foreground/80 text-lg mb-8 max-w-2xl mx-auto">
						Visit our shop or contact us today. We're here to help you with all
						your agricultural input needs.
					</p>
